...
<html lang="zxx">
    <head>
        ...
        <meta name="description" content="A platform where businesses trade goods and services directly with each other.">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <!--====== Title ======-->
        <title>TRAID - Your no.1 B2B platform</title>
        <!--====== Favicon Icon ======-->
        <link rel="shortcut icon" href="assets/images/" type="image/png"> 
        <!--====== Google Fonts ======-->
        <link href="css2?family=Manrope:wght@200..800&family=Plus+Jakarta+Sans:ital,wght@0,200..800;1,200..800&display=swap" rel="stylesheet">
        <!--====== Flaticon css ======-->
    ...
    <body class="software-website">
        ...
        <!--===  Header Area  ===-->
        <header class="header-area header-two transparent-header" style="top:0"> 
            <!--====  Header Navigation  ===-->
                ...
                <div class="nav-inner-menu">
                    ...
                    <div class="primary-menu">
                        ...
                        <div class="site-branding">
                         <img src="images/logo/logo-light.png" alt="img" width="40px">
                            <!-- <a href="index.html"><img src="assets/images/logo/logo.png" alt="Brand Logo"></a> -->
                        </div>
                        <!--=== Sasly Main Menu===-->
                        <div class="sasly-nav-menu">
                            ...
                            <div class="sasly-nav-button mt-20 d-block d-md-none">
                                <a href="login" class="theme-btn style-one">Sign in<i class="fa fa-angle-double-right"></i></a>
                            </div>
                            <!--=== Sasly Menu Bottom ===-->
        ...
        <div id="smooth-wrapper">
            <div id="smooth-content">
                ...
                <main>
                    ...
                    <section class="hero-ss bg_cover" style="background-image: url(assets/images/hero/hero_bg1.png);">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="co-lg-12">
                                    ...
                                    <div class="hero-content text-center">
                                        <span class="sub-heading"><i class="fa fa-arrow-right"></i>Welcome to TRAID</span>
                                        <h1 class="text-anm">Smart Advertising, <br>
                                        Serious Growth.</h1>
                                        <p data-aos="fade-up" data-aos-duration="1000">At TRAID, we believe growth starts with strategy. That’s why our approach to B2B advertising is driven by insight, precision, and creativity.</p>
                                        <div class="hero-button" data-aos="fade-up" data-aos-duration="1200">
                                            <a href="onboarding" class="theme-btn style-one">Get Started<i class="fa fa-angle-double-right"></i></a>
                                            <a href="register" class="theme-btn style-two">Create Account<i class="fa fa-angle-double-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <!--===  Hero Image  ===-->
                                    <div class="hero-image text-center" data-aos="fade-up" data-aos-duration="1400">
                                        <img src="assets/images/hero/hero1.jpg" alt="Hero Image">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="section-title text-center mb-70">
                                        <h2 class="text-anm">With us, your business isn’t just seen,  <br>
                                            it’s remembered, trusted, and chosen.</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="features-wrapper">
                                        <div class="row justify-content-center">
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <!--===  Iconic Box  ===-->
                                                <div class="sasly-iconic-box style-three mb-40" data-aos="fade-up" data-aos-duration="1200">
                                                    <div class="icon">
                                                        <i class="fa fa-rocket"></i>
                                                    </div>
                                                    <div class="content">
                                                        <h4 class="title">Peer-to-peer Ads</h4>
                                                        <p>We offer expert consultations design they address unique business challenges</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <!--===  Iconic Box  ===-->
                                                <div class="sasly-iconic-box style-three mb-40" data-aos="fade-up" data-aos-duration="1500">
                                                    <div class="icon">
                                                        <i class="fa fa-layer-group"></i>
                                                    </div>
                                                    <div class="content">
                                                        <h4 class="title">B2B Ads</h4>
                                                        <p>We offer expert consultations design they address unique business challenges</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <!--===  Iconic Box  ===-->
                                                <div class="sasly-iconic-box style-three mb-40" data-aos="fade-up" data-aos-duration="1700">
                                                    <div class="icon">
                                                        <i class="fal fa-gift"></i>
                                                    </div>
                                                    <div class="content">
                                                        <h4 class="title">B2C Ads</h4>
                                                        <p>We offer expert consultations design they address unique business challenges</p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    ...
                                    <div class="section-content-box mb-50">
                                        ...
                                        <div class="section-title">
                                            <h2 class="mb-20 text-anm">Build Trust with other businesses </h2>
                                        </div>
                                        <p data-aos="fade-up" data-aos-duration="1200">Our focus is simple: helping businesses reach other businesses with precision, clarity, and impact. Through innovative strategies and targeted campaigns, we amplify your brand’s voice in the marketplace, ensuring it reaches the right decision-makers.</p>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <!--===  Sasly Iconic Box  ===-->
                                                <div class="sasly-iconic-box style-four mt-40" data-aos="fade-up" data-aos-duration="1200">
                                                    <div class="icon">
                                                        <i class="fas fa-check"></i>
                                                    </div>
                                                    <div class="content">
                                                        <h6>Client-centric</h6>
                                                        <p>Services are customized they meet the needs goals</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <!--===  Sasly Iconic Box  ===-->
                                                <div class="sasly-iconic-box style-four mt-40" data-aos="fade-up" data-aos-duration="1500">
                                                    <div class="icon">
                                                        <i class="fas fa-check"></i>
                                                    </div>
                                                    <div class="content">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="feature-image-box mb-50" data-aos="fade-left" data-aos-duration="1700">
                                        <img src="assets/images/other.jpg" alt="Features Image">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="services-ss d-none">
                        <div class="service-bg-wrapper bg_cover pt-120 pb-60" style="background-image: url(assets/images/bg/feature-bg1.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <!--=== Section Title  ===-->
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <!--=== Sasly Card Item  ===-->
                                        <div class="sasly-card-item style-two mb-70" data-aos="fade-up" data-aos-duration="1200">
                                            <div class="row align-items-center">
                                                <div class="col-lg-6">
                                                    <!--=== Card Image Box  ===-->
                                                    <div class="card-image-box">
                                                        <div class="image-one">
                                                            <img src="assets/images/features/feature2.jpg" class="animate-float-bob-x" alt="Features Image">
                                                        </div>
                                                        <div class="image-two">
                                                            <img src="assets/images/features/feature3.jpg" class="animate-float-bob-y" alt="Features Image">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="card-content">
                                                        <h3 class="title">Manage All Cards in Place</h3>
                                                        <p>Welcome to Software the ultimate solution designed to streamline your industry-specific task or business function. With user-friendly interface and powerful features Software empowers.</p>
                                                        ...
                                                        <a href="#" class="theme-btn style-one">Get Started <i class="fa fa-angle-double-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <!--=== Sasly Card Item  ===-->
                                        <div class="sasly-card-item style-two mb-70" data-aos="fade-up" data-aos-duration="1500">
                                            <div class="row align-items-center">
                                                <div class="col-lg-6">
                                                    <!--=== Card Image Box  ===-->
                                                    <div class="card-image-box">
                                                        <div class="image-one">
                                                            <img src="assets/images/features/feature4.jpg" class="animate-float-bob-x" alt="Features Image">
                                                        </div>
                                                        <div class="image-two">
                                                            <img src="assets/images/features/feature5.jpg" class="animate-float-bob-y" alt="Features Image">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <!--=== Card Content  ===-->
                                                    <div class="card-content">
                                                        <h3 class="title">Real-time visibility into every expense</h3>
                                                        <p>Software adapts to your needs, providing real-time analytics, seamless integrations, and unparalleled support. Experience the future of specific industry a function with Software Name where innovation meets simplicity</p>
                                                        <a href="#" class="theme-btn style-one">Get Started <i class="fa fa-angle-double-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <!--=== Sasly Card Item  ===-->
                                        <div class="sasly-card-item style-two mb-70" data-aos="fade-up" data-aos-duration="1700">
                                            <div class="row align-items-center">
                                                <div class="col-lg-6">
                                                    <!--=== Card Image Box  ===-->
                                                    <div class="card-image-box">
                                                        <div class="image-one">
                                                            <img src="assets/images/features/feature6.jpg" class="animate-float-bob-x" alt="Features Image">
                                                        </div>
                                                        <div class="image-two">
                                                            <img src="assets/images/features/feature7.jpg" class="animate-float-bob-y" alt="Features Image">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <!--=== Card Content  ===-->
                                                    <div class="card-content">
                                                        <h3 class="title">Track your Marketing think 
                                                            Results a Analyze Sales</h3>
                                                        <p>Welcome to Software the ultimate solution designed to streamline your industry-specific task or business function. With user-friendly interface and powerful features Software empowers.</p>
                                                        <ul class="check-list style-one">
                                                            <li><i class="fas fa-badge-check"></i>Growth Method Analysis</li>
                                                            <li><i class="fas fa-badge-check"></i>Transforming Business</li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <!--=== Section Title  ===-->
                                    <div class="section-title text-center mb-60">
                                        <h2 class="text-anm">Our Pricing <br>
                                            </h2>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="pricing-wrapper" data-aos="fade-up" data-aos-duration="1200">
                                        <div class="table-responsive">
                                            <div class="table-area">
                                                <div class="pricing-item style-one">
                                                    <!--=== Pricing Header  ===-->
                                                    <div class="pricing-header">
                                                        <div class="pricing-title">
                                                            <h4>With us, your business isn’t just seen,
it’s remembered, trusted, and chosen. </h4>
                                                    ...
                                                    <div class="pricing-body">
                                                        ...
                                                        <!--=== Pricing Body Item  ===-->
                                                        <div class="pricing-body-item">
                                                            <div class="pricing-title">Streamlined information sharing</div>
                                                            <div class="pricing-list"><i class="fa fa-times"></i></div>
                                                            <div class="pricing-list bg-active"><i class="fa fa-check"></i></div>
                                                            <div class="pricing-list"><i class="fa fa-check"></i></div>
                                                        </div>
                                                        <!--=== Pricing Body Item  ===-->
                                                        <div class="pricing-body-item">
                                                            <div class="pricing-title">Knowledge Management</div>
                                                            <div class="pricing-list"><i class="fa fa-times"></i></div>
                                                            <div class="pricing-list bg-active"><i class="fa fa-check"></i></div>
                                                            <div class="pricing-list"><i class="fa fa-check"></i></div>
                                                        </div>
                                                    ...
                                                    <div class="pricing-footer">
                                                        ...
                                                        <div class="pricing-button bg-active">
                                                            <a href="#" class="theme-btn style-one">Get Started <i class="fa fa-angle-double-right"></i></a>
                                                        </div>
                                                        <div class="pricing-button">
                                                            <a href="#" class="theme-btn style-one">Get Started <i class="fa fa-angle-double-right"></i></a>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="section-title text-center mb-50" data-aos="fade-up" data-aos-duration="800">
                                        <h3 class="title text-anm">Partners</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <!--=== Section Title ===-->
                                    <div class="section-title text-center mb-60">
                                        <h2 class="text-anm">FAQs & Latest News <br>
                                            </h2>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xl-6">
                                    <!--=== Blog Post Item ===-->
                                    <div class="blog-post-item style-two mb-30" data-aos="fade-up" data-aos-duration="1200">
                                        <div class="post-thumbnail">
                                            <img src="assets/images/blog/blog1.jpg" alt="Blog Thumbnail">
                                        </div>
                                        <div class="post-content">
                                            <div class="post-meta style-one">
                                                <span class="category"><a href="#">SaaS</a></span>
                                                <span class="date"><a href="#">September 20, 2024</a></span>
                                            </div>
                                            <h4 class="title"><a href="#">How to Leverage Data-Driven Decisions for Business Growth</a></h4>
                                            <p>The teams truly understands industry
                                                approach helped streamline</p>
                                            <a href="#" class="read-more style-one"><i class="fa fa-plus"></i> Read More</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <!--=== Blog Post Item ===-->
                                    <div class="blog-post-item style-two mb-30" data-aos="fade-up" data-aos-duration="1500">
                                        <div class="post-thumbnail">
                                            <img src="assets/images/blog/blog2.jpg" alt="Blog Thumbnail">
                                        </div>
                                        <div class="post-content">
                                            <div class="post-meta style-one">
                                                <span class="category"><a href="#">SaaS</a></span>
                ...
                <footer class="software-footer primary-black-bg">
                    <div class="container">
                        <!--=== Newsletter Wrapper  ===-->
                        <div class="newsletter-wrapper bg_cover pt-100 pb-100" data-aos="fade-up" data-aos-duration="1200" style="background-image: url(assets/images/bg/cta-bg1.png);">
                            <div class="row justify-content-center">
                                <div class="col-lg-10">
                                    <!--=== Section Content Box  ===-->
                                    <div class="section-content-box text-white text-center">
                                        ...
                                        <a href="#" class="theme-btn style-one">More about us<i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="footer-content">
                                                    ...
                                                    <p><a href="mailto:support@traid.com">support@gmail.com</a></p>
                                                    <p><a href="tel:+2330000000">+233 00000000000</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="footer-content">
                                            ...
                                            <form>
                                                <div class="form-group">
                                                    ...
                                                    <button class="theme-btn style-one">Subscribe <i class="fa fa-angle-double-right"></i></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="copyright-text">
                                        <p>&copy; 2025 <span>TRAID</span> - All rights reserved.</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
