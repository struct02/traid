...
<body>
    ...
    <div class="app-content style-4 signIn-area">
        <div class="tf-container">
            ...
            <p class="mt-16 mb-20 body-2 text-dark-4">We do not share your personal details</p>
        ...
        @csrf
                <div class="mt-32 form-field form-2">
                    ...
                    <fieldset class="input-icon mt-12">
                        ...
                        <input type="text" placeholder="Type your full name" class="form-control" name="name">
                    </fieldset>
                </div>
                ...
                <div class="mt-20 form-field form-2">
                    ...
                    <fieldset class="mt-16 input-icon">
                        <div class="box-view-hide">
                            ...
                            <input type="password" placeholder="Type your password" class="form-control password-field2" name="password_confirmation">
                ...
                <button class="mt-40 tf-btn primary" type="submit">Sign Up</button>
            </form>
            ...
            <p class="mt-35 text-center body-2 text-dark-4">Already have an account? <a href="login" class="text-primary button-1">Sign In</a></p>
        </div>
