...
<head>
    <meta charset="UTF-8">
    <title>TRAID - Advertise your Business</title>
    <meta name="viewport"
...
<body>
    ...
    <div class="app-content style-2">
        <div class="tf-container">
            <div class="search-box">
                ...
                <input type="text" name="query" value="{{ request('query') }}" class="search-field" placeholder="Search...">

                
                <span class="right-icon">
                   <button type="submit" class="btn-sm" style="background: none">  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.5">
                            <path
                                d="M9.58317 17.4998C13.9554 17.4998 17.4998 13.9554 17.4998 9.58317C17.4998 5.21092 13.9554 1.6665 9.58317 1.6665C5.21092 1.6665 1.6665 5.21092 1.6665 9.58317C1.6665 13.9554 5.21092 17.4998 9.58317 17.4998Z"
                                stroke="#121927" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="category-job">
                                ...
                                <a class="title" href="#">Full Time</a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="category-job">
                                ...
                                <a class="title" href="#">Part Time</a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="category-job">
                                ...
                                <a class="title" href="#">Freelance</a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="category-job">
 ...
 <div class="container-fluid mt-24 px-0">
      <div class="row">
   ...
   Job Ad 1
    ...
    <div class="menubar-footer footer-fixed">
        <ul class="inner-bar">
            ...
            <li class="action-add"><a href="advertise">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="sidebar-content">
                    ...
                    <ul class="pt-20 pb-20">
                        ...
                        <li class="mt-18 sub-menu" id="accordionExample">
                            <a href="dashboard" class="nav-link-item no-page">
                ...
                <div class="overflow-auto pb-32">
                    <div class="tf-container">
                        <ul>
                            ...
                            <li><a href="#" class="nav-link-item pt-16 pb-16 line-bt no-page">
                                    <span>All Job</span>
                                </a></li>
